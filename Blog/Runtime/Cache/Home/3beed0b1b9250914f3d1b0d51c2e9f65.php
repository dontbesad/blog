...
<html>
    ...
    <body>
        <div class="form">
            ...
            <div class="verify">
                <img src="/blog/index.php/Home/User/showVerify" alt="验证码" onclick="this.src='/blog/index.php/Home/User/showVerify?'+Math.floor(Math.random()*1000);">
                <input type="text" placeholder="验证码(刷新请点击图片)" id="verify_code">
            </div>
            <span id="message"></span><input type="submit" value="注　册" id="submit_btn">
            <div class="br"><hr></div>
            <a href="/blog/index.php/Home/User/login">已有帐号?去登录</a><a href="/blog/index.php/Home" style="float:right">[返回首页]</a>
        </div>
    </body>
</html>
...
document.getElementById("submit_btn").onclick = function() {
    ...
    xhr.open("POST", "/blog/index.php/Home/User/registerAction", true);
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && (xhr.status === 200 || xhr.status === 304)) {
            ...
            if (response.flag) {
                document.write(response.message + ",3秒之后跳转到登录页面。" + "<a href='/blog/index.php/Home/User/login'>[立即跳转]</a>");
                setTimeout(function(){
                    location.href = "/blog/index.php/Home/User/login";
                },3000);
            } else {
