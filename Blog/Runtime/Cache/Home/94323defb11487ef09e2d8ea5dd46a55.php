...
<html>
    ...
    <body>
        <div class="form">
            ...
            <div class="br"><hr></div>
            <a href="/blog/index.php/Home/User/register">没有帐号? 去注册一个</a><a href="/blog/index.php/Home" style="float:right">[返回首页]</a>
        </div>
    </body>
</html>
...
document.getElementById("submit_btn").onclick = function() {
    ...
    xhr.open("POST", "/blog/index.php/Home/User/loginAction", true);
